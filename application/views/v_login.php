                                        ...
                                        <div class="block-content">
                                            <div class="form-group row">
                                                <div class="col-12">
                                                    ...
                                                    <input type="text" class="form-control" id="login-username" placeholder = "No. Induk Pegawai" name="uname" required>
                                                </div>
                                            </div>
                                            <div class="form-group row">
                                                <div class="col-12">
                                                    <label for="login-password">Password</label>
                                                    <input type="password" class="form-control" id="login-password" placeholder="********" name="pass" required>
                                                </div>
                                            </div>
