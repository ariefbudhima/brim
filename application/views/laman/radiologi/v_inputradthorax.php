                      ...
                      <div class="row">
                        <div class="col-lg-4">
                          ...
                          <div class="tabelku">
                            ...
                            <input type="radio" name="Ekspansi" value="Tidak"> Tidak Normal <input type="text" name="keterangan" value="">
                          </div>
                          <br>
                          <?php echo "Palpasi" ?><br>
                          <div class="tabelku">
                        ...
                        <div class="col-lg-4">
                          ...
                          <div class="tabelku">
                            ...
                            <input type="radio" name="Perkusi" value="Tidak"> Tidak Normal <input type="text" name="keterangan" value="">
                          </div>
                          <br>
                          <?php echo "Auskultasi" ?><br>
                          <div class="tabelku">
                            <input type="radio" name="Auskultasi" value="Normal"> Normal <br>
                            <input type="radio" name="Auskultasi" value="Tidak"> Tidak Normal <input type="text" name="keterangan" value="">
                          </div>
                          <br>
                          <?php echo "Lainnya" ?><br>
                          <div class="tabelku">
